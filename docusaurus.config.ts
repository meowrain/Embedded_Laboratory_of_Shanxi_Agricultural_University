...
const config: Config = {
  title: '山西农业大学嵌入式实验室',
  url: 'https://meowrain.github.io/Embedded_Laboratory_of_Shanxi_Agricultural_University',
  baseUrl: ' /',
  ...
  customFields: {
    bio: '道阻且长，行则将至',
    description:
      '山西农业大学嵌入式实验室官网，该网站基于React 驱动的静态网站生成器 Docusaurus 构建。',
  },
  themeConfig: {
    // announcementBar: {
    ...
    [
      './src/plugin/plugin-content-blog', // 为了实现全局 blog 数据，必须改写 plugin-content-blog 插件
      {
        ...
        feedOptions: {
          type: 'all',
          title: 'SXAUEL',
          copyright: `Copyright © ${new Date().getFullYear()} SXAUEL Built with Docusaurus.<p><a href="http://beian.miit.gov.cn/" class="footer_lin">${beian}</a></p>`,
        },
      },
    ],
